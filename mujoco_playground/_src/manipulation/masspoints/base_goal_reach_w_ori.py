...
from mujoco_playground._src.manipulation.masspoints import masspoint_reach_ori_constants as consts
...
class MasspointsGoalReachEnv(mjx_env.MjxEnv):
  ...
  def _post_init(self):
    ...
    self.workspace_center = jp.array([0.56784, 0.0, 0.0306525])

    masspoint_1_name = "mp_0"
    masspoint_2_name = "mp_1"
    self._mp_1_body = self.mj_model.body(masspoint_1_name).id
    self._mp_2_body = self.mj_model.body(masspoint_2_name).id
