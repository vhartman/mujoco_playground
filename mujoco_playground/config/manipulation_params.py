...
def brax_ppo_config(
  ...
  if env_name == "AlohaHandOver":
    ...
    rl_config.num_timesteps = 2_800_000_000
    rl_config.num_evals = 10
    rl_config.unroll_length = 100
    rl_config.num_minibatches = 32
    rl_config.num_updates_per_batch = 8
  ...
  elif env_name == "TesolloCubeRotateZAxis":
    rl_config.num_timesteps = 1_000_000_000
    rl_config.num_evals = 10000
    rl_config.num_minibatches = 32
    rl_config.unroll_length = 40
    rl_config.num_updates_per_batch = 4
    rl_config.discounting = 0.97
  ...
  elif env_name == "TesolloCubeReorient":
    rl_config.num_timesteps = 1_000_000_000
    rl_config.num_evals = 20
    rl_config.num_minibatches = 32
    rl_config.unroll_length = 40
    ...
    rl_config.num_resets_per_eval = 1
  elif env_name == "TesolloWristCubeReorient":
    rl_config.num_timesteps = 1_000_000_000
    rl_config.num_evals = 20
    rl_config.num_minibatches = 32
    rl_config.unroll_length = 40
    ...
    rl_config.learning_rate = 1e-4
    rl_config.entropy_cost = 1e-2
    # Clip the global grad norm: the pinch critic has blown up (v_loss ~1e4,
    # reward collapse) on some seeds without it.
    rl_config.max_grad_norm = 1.0
    rl_config.num_envs = 8192
    rl_config.batch_size = 256
    rl_config.network_factory = config_dict.create(
